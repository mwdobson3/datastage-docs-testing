  ...
  steps={[
    {
      ...
      duration: '5 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/prerequisites'
    },
    {
      id: 'launch-ec2',
      title: 'Launch EC2 Instance',
      description: 'Create and configure AWS instance',
      duration: '10 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/launch-ec2'
    },
    {
      id: 'install-docker',
      title: 'Install Docker',
      description: 'Set up Docker with secondary storage',
      duration: '10 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/install-docker'
    },
    {
      id: 'generate-keys',
      title: 'Generate Encryption Keys',
      description: 'Create security credentials',
      duration: '5 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/generate-keys'
    },
    {
      id: 'deploy-engine',
      title: 'Deploy Remote Engine',
      description: 'Install DataStage with Docker',
      duration: '10 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/deploy-engine'
    },
    {
      id: 'verify-configure',
      title: 'Verify and Configure',
      description: 'Test deployment and connect to Cloud Pak',
      duration: '5-10 min',
      link: '/datastage-docs-testing/docs/tutorials/aws-docker-engine/verify-configure'
    }
  ]}
/>
