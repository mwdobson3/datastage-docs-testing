...
|------------|--------------|---------|
| `YOUR_CONTAINER_REGISTRY_API_KEY` | Your IBM Cloud API key | `rmoZA3EHTFjoAbWbQoRWSq2eVC1NS9k8PQ7gJ-uNNXKV` |
| `YOUR_IBM_CLOUD_API_KEY` | Your IBM Cloud API key (same as above) | `qSOipvfdwXJjHSWxIgVd7u0d2V2WHsOR9A_V1SntP762` |
| `YOUR_PROJECT_ID` | Your Cloud Pak for Data project ID | `5343d6a6-bd2b-401c-abc3-9fd7747335d3` |
