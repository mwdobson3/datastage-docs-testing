...
|------------|--------------|---------------|
| `YOUR_CONTAINER_REGISTRY_API_KEY` | Your IBM Cloud Container Registry API key | [IBM Cloud API Keys](https://cloud.ibm.com/iam/apikeys) |
| `YOUR_IBM_CLOUD_API_KEY` | Your IBM Cloud API key (same as above) | [IBM Cloud API Keys](https://cloud.ibm.com/iam/apikeys) |
| `YOUR_PROJECT_ID` | Your Cloud Pak for Data project ID | Project settings in Cloud Pak for Data |
...
namespace=tutorial
username=iamapikey
password=YOUR_ACTUAL_CONTAINER_REGISTRY_API_KEY
api_key=YOUR_ACTUAL_IBM_CLOUD_API_KEY
...
| `password` | IBM Cloud Container Registry API key | Your API key |
| `api_key` | IBM Cloud API key | Your API key |
| `projectId` | Cloud Pak for Data project ID | Your project ID |
