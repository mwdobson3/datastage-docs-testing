...
- ✅ Provisioned an AWS EKS cluster
- ✅ Configured kubectl access
- ✅ Created configuration file
- ✅ Deployed DataStage operator
- ✅ Deployed Remote Engine pods
- ✅ Registered with IBM Cloud
- ✅ Verified deployment
- ✅ Configured in Cloud Pak for Data
