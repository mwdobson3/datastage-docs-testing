...
2. Click **New asset** → **DataStage flow**
...
975b01b5bf61   icr.io/datastage/ds-px-runtime   "/bin/bash -c /px-st…"   10 minutes ago   Up 10 minutes (healthy)   9443/tcp   aws-getting-started_runtime
```
...
- ✅ Verified Remote Engine registration in IBM Cloud
- ✅ Configured the Remote Engine as default for your project
- ✅ Viewed detailed engine information and status
- ✅ Tested the Remote Engine with a sample job
- ✅ Learned how to manage and monitor the engine
- ✅ Understood best practices for operation and maintenance
