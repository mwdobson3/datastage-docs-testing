...
1. **IBM Cloud API Key**
   ...
   - Example format: `qSOipvfdwXJjHSWxIgVd7u0d2V2WHsOR9A_V1SntP762`

2. **IBM Cloud Container Registry API Key**
   - Same as your IBM Cloud API key
   - Example format: `rmoZA3EHTFjoAbWbQoRWSq2eVC1NS9k8PQ7gJ-uNNXKV`

3. **Project ID**
   - From your Cloud Pak for Data project settings
   - Example format: `5343d6a6-bd2b-401c-abc3-9fd7747335d3`
...
IBM Cloud API Key: qSOipvfdwXJjHSWxIgVd7u0d2V2WHsOR9A_V1SntP762
...
Container Registry API Key: rmoZA3EHTFjoAbWbQoRWSq2eVC1NS9k8PQ7gJ-uNNXKV
